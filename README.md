...
```javascript
import cuany from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-cuany@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-cuany@v0.1.1-deno/mod.js';
```
